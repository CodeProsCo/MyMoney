...
(function(root, factory) {
    ...
    function(exports) {
        ...
        function _exitIntro(targetElement) {
            ...
            if (showElement) {
                showElement.className = showElement.className.replace(/introjs-[a-zA-Z]+/g, "")
        ...
        function _showElement(targetElement) {
            ...
            if (oldHelperLayer != null) {
                ...
                if (oldHelperNumberLayer != null) {
                    ...
                    if (lastIntroItem != null &&
                    (this._direction == "forward" && lastIntroItem.position == "floating"
                    ) ||
                ...
                if (oldShowElement) {
                    oldShowElement.className = oldShowElement.className.replace(/introjs-[a-zA-Z]+/g, "")
                        .replace(/^\s+|\s+$/g, "");
                }
                ...
                self._lastShowElementTimer = setTimeout(function() {
                        ...
                        oldReferenceLayer.querySelector(".introjs-progress .introjs-progressbar")
            ...
            while (parentElm != null) {
                ...
                var transform = _getPropValue(parentElm, "transform") ||
            ...
            if (!_elementInViewport(targetElement.element) && this._options.scrollToElement === true) {
                ...
                if (top < 0 || targetElement.element.clientHeight > winHeight) {
                    ...
                    window
                        .scrollBy(0, bottom + 70 + this._options.scrollPadding);
