                ...
                module = {
                    ...
                    create: {
                        calendar: function() {
                            ...
                            for (p = 0; p < pages; p++) {
                                ...
                                var firstMonthDayColumn = (new Date(year, month, 1).getDay() -
                                ...
                                var prevDate = new Date(year - yearChange,
                                    month - monthChange,
                                    prevNextDay - dayChange,
                                    hour);
                                var nextDate = new Date(year + yearChange,
                                    month + monthChange,
                                    prevNextDay + dayChange,
                                    hour);
                                ...
                                var prevLast = isYear
                                    ...
                                    : isMonth
                                    ? new Date(year, 0, 0)
                                    : isDay ? new Date(year, month, 0) : new Date(year, month, day, -1);
                                var nextFirst = isYear
                                    ? new Date(Math.ceil(year / 10) * 10 + 1, 0, 1)
                                    : isMonth
                                    ? new Date(year + 1, 0, 1)
                                    : isDay ? new Date(year, month + 1, 1) : new Date(year, month, day + 1);

                                var table = $("<table/>")
                                    .addClass(className.table)
                                    .addClass(columnsString + " column")
                                    .addClass(mode)
                                    .appendTo(container);
                                ...
                                if (!isTimeOnly) {
                                    ...
                                    if (p === 0) {
                                        ...
                                        prev.toggleClass(className.disabledCell,
                                    ...
                                    if (p === pages - 1) {
                                        ...
                                        next.toggleClass(className.disabledCell,
                                    ...
                                    if (isDay) {
                                        ...
                                        for (i = 0; i < columns; i++) {
                                            ...
                                            cell.text(formatter
                                                .dayColumnHeader((i + settings.firstDayOfWeek) % 7, settings));
                                        }
                                    }
                                }
                                ...
                                for (r = 0; r < rows; r++) {
                                    ...
                                    for (c = 0; c < columns; c++, i++) {
                                        ...
                                        var cellText = isYear
                                            ...
                                            : isDay ? cellDate.getDate() : formatter.time(cellDate, settings, true);
                                        cell = $("<td/>").addClass(className.cell).appendTo(row);
                                        cell.text(cellText);
                                        cell.data(metadata.date, cellDate);
                                        var adjacent = isDay && cellDate.getMonth() !== ((month + 12) % 12);
                                        var disabled = adjacent ||
                                        ...
                                        if (!isHour && !isMinute) {
                                            cell
                                                .toggleClass(className.todayCell,
                                                    !adjacent && module.helper.dateEqual(cellDate, today, mode));
                                        }
                            ...
                            container.find("td")
                                .each(function() {
                                    ...
                                    cell.toggleClass(className
                                        .focusCell,
                                        focused && (!isTouch || isTouchDown) && !adjacent);
                        ...
                        keydown: function(event) {
                            ...
                            if (module.popup("is visible")) {
                                if (event.keyCode === 37 ||
                                    ...
                                    var increment = event.keyCode === 37
                                        ? -1
                                        : event.keyCode === 38 ? -bigIncrement : event.keyCode == 39 ? 1 : bigIncrement;
                    ...
                    get: {
                        ...
                        mode: function() {
                            ...
                            return settings.type === "time"
                                ? "hour"
                                : settings.type === "month" ? "month" : settings.type === "year" ? "year" : "day";
                        },
                        validModes: function() {
                            var validModes = [];
                            if (settings.type !== "time") {
                    ...
                    set: {
                        ...
                        focusDate: function(date, refreshCalendar, updateFocus, updateRange) {
                            ...
                            updateFocus = (updateFocus !== false && changed && refreshCalendar === false) ||
...
//equality test for dates and string objects
                            if (value) {
                        ...
                        isDateInRange: function(date, mode, minDate, maxDate) {
                            ...
                            minDate = minDate &&
                                new Date(minDate.getFullYear(),
                                    ...
                                    minDate.getDate(),
                                    minDate.getHours(),
                                    5 * Math.ceil(minDate.getMinutes() / 5));
                            return !(!date ||
                    ...
                    verbose: function() {
                        if (!settings.silent && settings.verbose && settings.debug) {
                            if (settings.performance) {
                                ...
                                module.verbose = Function.prototype.bind
                                    .call(console.info, console, settings.name + ":");
