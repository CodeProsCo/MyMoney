        ...
        defaults: {
            ...
            highlight: function(element, errorClass, validClass) {
                if (element.type === "radio") {
                    this.findByName(element.name).closest(".field").addClass(errorClass).removeClass(validClass);
                } else {
            ...
            unhighlight: function(element, errorClass, validClass) {
                if (element.type === "radio") {
                    this.findByName(element.name).closest(".field").removeClass(errorClass).addClass(validClass);
                } else {
